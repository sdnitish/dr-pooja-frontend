        ...
        <section className="home-about my-4 md:my-[80px]">
            <div className="container">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div className="relative md:mx-10 mx-0">
                        <div className="reative">
                            <img className='w-full rounded-tl-[250px] rounded-br-[250px] reative z-10' src="/img/about.png" alt="About" />
                            <div className="absolute top-0 left-0 w-full h-full rounded-tl-[250px] rounded-br-[250px] bg-[#8a56f0] z-[-1] rotate-z-[-9deg]"></div>
                        </div>
                         <div className="absolute right-0 md:right-[-40px] bottom-[5%] md:bottom-[17%] bg-[#8a56f0] py-3 px-4 md:px-6 text-center rounded-2xl">
